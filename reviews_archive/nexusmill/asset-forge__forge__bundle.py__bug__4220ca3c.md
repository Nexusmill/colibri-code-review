...
The fixes were applied after this review hashed the bytes above; the file is now `8feab1eaa78f90b4a96e1d8104aae37bb5e451865455a7a00e0e9804376a3563`. Rows AF-BUNDLE-CANCEL-RECEIPT, AF-BUNDLE-ORPHAN-DIR in `docs/remediation_manifest.json`, same commit.
