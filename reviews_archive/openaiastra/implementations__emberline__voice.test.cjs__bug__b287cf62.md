...
BLOCK pending current-effect advice fix. Other reviewed scheduler/count paths have no confirmed defect.
...
Current shield snapshot is missing from advice scheduling.
